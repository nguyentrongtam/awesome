...
mytextclock = awful.widget.textclock(markup("#7788af", "%A-%d-%m ") .. markup("#343639", "") .. markup("#de5e1e", " %H:%M "))
...
for s = 1, screen.count() do
    ...
    left_layout:add(bottom_right_layout)
    -- left_layout:set_middle(mytasklist[s])
